...
open("results/annual_no_contraint_H2/results.csv", "w") do f
...
open("results/annual_no_contraint_H2/parc_annuel.json", "w") do f
...
# Écriture dans fichier JSON
open("results/annual_no_contraint_H2/evolution_parc.json", "w") do f
